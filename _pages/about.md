...
# Research Interest
My personal research focuses on Counterfactual Machine Learning for Learning-to-Rank Systems, which aims to solve various bias issues existing in the system, such as selection bias, position bias, and popularity bias. It also involves concepts of Stable Learning, Causal Inference and Missing Not At Random (MNAR). The application domain of my research includes Recommender System and Advertising System. I appreciate simple and effective models, and I want to do work that can receive interest from the industry.
